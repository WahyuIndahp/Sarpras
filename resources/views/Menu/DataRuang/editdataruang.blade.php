            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li>
                            <h4 class="page-title">EDIT DATA RUANG</h4>
                        </li>
                    </ul>
                        ...
                        <div class="col-sm-10 col-sm-offset-1">
                            ...
                            <div class="row">
                        				<div class="col-lg-10 col-sm-offset-1">
                        					<form class="form-horizontal" role="form" method="POST" action="/dataruangsekolah/{{ $data->id }}" enctype="multipart/form-data">
	                                            @csrf
                                                @method('PUT')
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label" style="text-align:left">Nama PJ Ruang</label>
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" name="pj_ruang" id="pj_ruang" value="{{ $data->pj_ruang }}">
	                                                </div>
	                                            </div>
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" name="nama_ruang" id="nama_ruang" value="{{ $data->nama_ruang }}">
	                                                </div>
	                                            </div>
                                                ...
                                                <div class="form-group m-t-10">
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <a href="/dataruangsekolah" type="submit"
