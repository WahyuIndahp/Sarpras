            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li>
                            <h4 class="page-title">FORM DATA SARPRAS</h4>
                        </li>
                    </ul>
                        ...
                        <div class="col-sm-10 col-sm-offset-1">
                            ...
                            <div class="row">
                        				<div class="col-lg-10 col-sm-offset-1">
                        					<form class="form-horizontal" role="form" method="POST" action="/datasarpras" enctype="multipart/form-data">
	                                            @csrf
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label" style="text-align:left">Kode Sarpras</label>
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" name="kode_sarpras" id="kode_sarpras" placeholder="Masukkan kode sarpras" required>
	                                                </div>
	                                            </div>
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" name="nama_sarpras" id="nama_sarpras" placeholder="Masukkan nama sarpras" required>
	                                                </div>
	                                            </div>
                                                ...
                                                <div class="form-group m-t-10">
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <a href="/datasarpras" type="submit"
