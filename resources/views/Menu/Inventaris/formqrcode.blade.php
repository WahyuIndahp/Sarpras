            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li>
                            <h4 class="page-title">FORM QRCODE</h4>
                        </li>
                    </ul>
                        ...
                        <div class="col-sm-10 col-sm-offset-1">
                            ...
                            <div class="row">
                        				<div class="col-lg-10 col-sm-offset-1">
                        					<form class="form-horizontal" role="form" method="POST" action="/dataqrcode" enctype="multipart/form-data">
	                                            @csrf
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-sm-10">
                                                        <select class="form-control sarpras2" name="inventaris_id" id="inventaris_id" required>
                                                            ...
                                                            <option value="{{$item->id}}">{{$item->kode_inventaris}}</option>
                                                            @endforeach
                                                            </optgroup>
                                                        </select>
                                                    </div>
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" name="link_detail" id="link_detail" placeholder="masukkan link detail inventaris" required>
	                                                </div>
	                                            </div>
