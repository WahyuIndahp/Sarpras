                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                <div class="m-b-30">
                                    <a href="/dataqrcode/create" type="button" class="btn btn-custom"><i
                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$qrcode->inventories->kode_inventaris}}</td>
                                            
                                            <td>{{$qrcode->inventories->sarprases->nama_sarpras}}</td>

                                            <td style="text-align:center"><div class="card-body">
                                                {!! QrCode::size(50)->generate($qrcode->link_detail) !!}
                                            </div></td>
                                            <td class="actions" style="text-align:center">
                                                <a href="/dataqrcode/{{ $qrcode->id }}/edit"
                                                    class="btn btn-icon waves-effect waves-light btn-success btn-xs m-b-5">
                                                    <i class="fa fa-pencil-square-o"></i> Edit </a>

                                                <form action="/dataqrcode/{{ $qrcode->id }}" method="post">
                                                    @method('delete')    
                                                    @csrf
