                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="actions" style="text-align:center">
                                                <a href="/datapembenahan/{{ $pembenahan->id }}/edit" class="btn btn-icon waves-effect waves-light btn-success btn-xs m-b-5"> <i class="fa fa-pencil-square-o"></i> Edit </a>
                                                &nbsp;&nbsp;
                                                <form action="/datapembenahan/{{ $pembenahan->id }}" method="post">
                                                    @method('delete')    
                                                    @csrf
