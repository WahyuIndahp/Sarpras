            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li>
                            <h4 class="page-title">EDIT KONDISI SARPRAS</h4>
                        </li>
                    </ul>
                        				...
                        				<div class="col-lg-10 col-sm-offset-1">
                        					<form class="form-horizontal" role="form" method="POST" action="/datakondisi/{{ $data->id }}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group m-t-10">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control"name="tgl_cek" value="{{ $data->tgl_cek->format('d-m-Y') }}" id="datepicker-autoclose">
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" name="detail_kondisi" id="detail_kondisi" value="{{ $data->detail_kondisi}}">
	                                                </div>
	                                            </div>
