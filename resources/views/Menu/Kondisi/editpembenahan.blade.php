            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li>
                            <h4 class="page-title">EDIT PEMBENAHAN SARPRAS</h4>
                        </li>
                    </ul>
                        ...
                        <div class="col-sm-10 col-sm-offset-1">
                            ...
                            <div class="row">
                        				<div class="col-lg-10 col-sm-offset-1">
                        					<form class="form-horizontal" role="form" method="POST" action="/datapembenahan/{{ $data->id }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="form-group m-t-10">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control"name="tgl_servis" value="{{ $data->tgl_servis->format('d-m-Y') }}" id="datepicker-autoclose">
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" name="detail_rusak" id="detail_rusak" value="{{ $data->detail_rusak}}">
	                                                </div>
	                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input class="form-control" type="file" name="foto_kondisi" id="formFile" value="{{ $data->foto_kondisi}}">
                                                    </div>
                                                </div>
