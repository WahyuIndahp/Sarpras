            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li>
                            <h4 class="page-title">EDIT PERMINTAAN SARPRAS</h4>
                        </li>
                    </ul>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-10 col-sm-offset-1">
                            <div class="card-box">
                                <div class="row">
                                    <form class="form-horizontal  col-sm-offset-1" role="form" method="POST" action="/datapermintaan/{{$data->id}}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="col-md-8 m-t-5">Tanggal</label>
                                                <div class="col-md-10">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control"name="tgl_minta" value="{{ $data->tgl_minta->format('d-m-Y') }}" id="datepicker-autoclose">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                &nbsp;&nbsp;
                                                    <a href="/datapermintaan" type="submit"
