                            ...
                            <div class="card-box">
                                <div class="row">
                        			<div class="col-lg-10 col-sm-offset-1">
                        					<form class="form-horizontal" role="form" method="POST" action="/datareturn" enctype="multipart/form-data">
	                                            @csrf
                                                <div class="form-group m-t-10">
	                                                <label class="col-md-2 control-label" style="text-align:left">Tanggal Kembali</label>
	                                                <div class="col-md-10">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control"name="tgl_kembali" placeholder="mm-dd-yyyy" id="datepicker-autoclose" required>
                                                ...
                                                <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <select class="form-control" name="pinjam_id" id="pinjam_id" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control" name="kondisi_sesudah" id="kondisi_sesudah" required>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" style="text-align:left">Foto Return Sarpras</label>
                                                    <div class="col-md-10">
                                                        <input class="form-control" type="file"  name="foto_kembali" id="formFile" required>
                                                    </div>
	                                            </div>
                                                <div class="form-group">
