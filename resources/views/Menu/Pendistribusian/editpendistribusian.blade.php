            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li>
                            <h4 class="page-title">EDIT PENDISTRIBUSIAN SARPRAS</h4>
                        </li>
                    </ul>
                        ...
                        <div class="col-sm-10 col-sm-offset-1">
                            ...
                            <div class="row">
                        				<div class="col-lg-10 col-sm-offset-1">
                        					<form class="form-horizontal" role="form" method="POST" action="{{url('/datapendistribusian/'.$data->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="form-group">
	                                                <label class="col-md-2 control-label" for="deskripsi" style="text-align:left">Deskripsi</label>
	                                                <div class="col-md-10 ">
