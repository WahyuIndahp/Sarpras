            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li>
                            <h4 class="page-title">EDIT PENGADAAN SARPRAS</h4>
                        </li>
                    </ul>
                                ...
                                <div class="row">
                                    <form class="form-horizontal" role="form" method="POST" action="/datapengadaan/{{ $data->id }}" enctype="multipart/form-data" name="autoSumForm">
                                            ...
                                            <div class="form-group">
			                            		...
			                            		<div class="col-sm-9">
			                        				<div class="input-group">
														<input type="text" class="form-control"name="tgl_beli" value="{{ $data->tgl_beli->format('d-m-Y') }}" id="datepicker-autoclose">
                                        ...
                                        <div class="col-lg-5 p-20 ">
                                            ...
                                            <div class="form-group p-10 m-b-30 m-t-30">
                                                <div class="col-sm-offset-1">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <a href="/datapengadaan" type="submit"
