...
<body class="fixed-left">
            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li>
                            <h4 class="page-title">DAFTAR DATA PENGADAAN</h4>
                        </li>
                    </ul>
                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align:center; vertical-align: middle;">Tanggal Beli</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ asset('fotopengadaan/'.$pengadaan->foto_terima)}}" class="image-popup" title="foto_terima">
                                                    <img src="{{ asset('fotopengadaan/'.$pengadaan->foto_terima)}}" style="width: 70px;" class="thumb-img" alt="work-thumbnail">
                                                </a>
                                            </td>
                                        </tr>
                                        @endforeach
    ...
    <!-- <tfoot>
    <th colspan="6" style="text-align:center;" style="text-align:right">TOTAL PENGELUARAN</th>
    <td style="text-align:right; font-weight:bold;">350000</td>
    </tfoot> -->
                                </table>
                            </div>
                        </div><!-- end col -->
