            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li>
                            <h4 class="page-title">EDIT PEREKAPAN</h4>
                        </li>
                    </ul>
            ...
            <div class="content">
                ...
                <div class="row">
                        <div class="col-sm-10 col-sm-offset-1">
                            <div class="card-box">
                                <div class="row">
                                    <form class="form-horizontal col-sm-offset-1" method="POST" action="/dataperekapan/{{ $data->id }}" enctype="multipart/form-data" role="form">
                                    @csrf
                                    @method('PUT')
                                    <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <input type="text" name="thn_ajr" id="thn_ajr" data-mask="9999" class="form-control" value="{{ $data->thn_ajr }}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                &nbsp;&nbsp;
                                                    <a href="/dataperekapan" type="submit"
